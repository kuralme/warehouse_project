...
class WarehouseNavigator(rclpy.node.Node):
    def __init__(self):
        ...
        # Waypoints [x, y, yaw]
        self.task_route = [
            [2.033, -1.872, -1.854],  # Initial pose
            [0.266, -5.896,  3.092],  # Loading
            [2.767, -4.151, -0.284],  # Shipping
        ]
        ...
        self.footprint_w_cart = ({
            "robot_radius": 0.0,
            "inflation_layer.inflation_radius": 0.44,
    ...
    def move_back_up(self):
        ...
        while rclpy.ok():
            ...
            error_distance = 1.0 - moved_distance
